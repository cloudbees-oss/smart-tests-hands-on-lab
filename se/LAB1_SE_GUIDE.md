...
A: Smart Tests hasn't learned test durations yet. After recording actual test results, it will show estimated durations.
...
Tells Smart Tests' ML model to optimize for "short-lived branch" scenario (vs. long-running feature branches or main branch testing).
...
- Note: With zero execution history, ML has limited data - results improve after recording test runs
...
**Solution:** With zero history, ML has limited signal. Emphasize this improves after Lab 2 when we record actual test results.
